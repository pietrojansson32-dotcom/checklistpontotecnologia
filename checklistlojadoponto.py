...
def home():
    ...
    <header>
        ...
        <nav>
            <a href="https://checklistpontotecnologia.onrender.com/docs">Documentação API</a>
    ...
    <footer>
        ...
        <p>Desenvolvido para Gestão Eficiente de Documentos.</p>
    </footer>
    ...
    <script>
        document.getElementById('checklistForm').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                statusDiv.innerText = "Falha ao conectar com a API. Verifique a conexão.";
                statusDiv.style.display = "block";
            } finally {
                btn.disabled = false;
...
def receber_checklist(dados: ChecklistData):
    ...
    return {"status": "sucesso", "mensagem": "Relatório profissional armazenado com sucesso!"}
